...
export default function AboutPage() {
  ...
  return (
    <div className="w-full bg-[#FAFBFC] min-h-screen montserrat-page  space-y-24">
      {/* 1. HERO BANNER */}
      <section
        className="relative w-full min-h-[92vh] lg:h-[92vh] bg-[#0F2D4A] px-[3vw] py-3 lg:py-16 overflow-hidden flex justify-center"
          ...
          <div className="flex justify-start mb-8 md:mb-14 ab-label">
            <div className="inline-flex items-center gap-4 text-white font-bold text-2xl uppercase">
              <span className="relative w-7 h-7 flex-shrink-0">
                <Image
                  src="/images/AboutAs/sectionIcons/aboutAs.webp"
                  alt="About Icon"
                  fill
...
`,
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center justify-between w-full px-[4vw]">
          ...
          <FadeIn
            className="relative w-full lg:max-w-[420px] lg:ml-8"
            direction="left"
            delay={0.1}
          >
            ...
            <div className="space-y-8">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0B2545] tracking-wider">
                {"Building Healthcare Infrastructure Since 1997"
                  ...
                  .map((word, wIdx, words) => {
                    const charOffset =
                      words.slice(0, wIdx).join(" ").length +
                      (wIdx > 0 ? 1 : 0);
                    return (
                      <React.Fragment key={wIdx}>
                        <span className="inline-block whitespace-nowrap">
                          {Array.from(word).map((char, cIdx) => (
                            <span
                              ...
                              style={{
                                opacity: 0,
                                animationDelay: `${(charOffset + cIdx) * 0.045}s`,
                              }}
                            >
                              {char}
                            </span>
                        ...
                        {wIdx < words.length - 1 && (
                          <span
                            ...
                            style={{
                              opacity: 0,
                              animationDelay: `${(charOffset + word.length) * 0.045}s`,
                            }}
                          >
                            {"\u00A0"}
                          </span>
...
`,
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/AboutAs/section3/section3bg.webp')",
        }}
      >
        <div
        ...
        >
            ...
            <div className="inline-flex items-center gap-4 text-[#0C3D6C] font-semibold text-xl uppercase">
              <span className="relative w-8 h-8 flex-shrink-0">
                <Image
                  ...
                  style={{
                    filter:
                      "brightness(0) saturate(100%) invert(39%) sepia(87%) saturate(1478%) hue-rotate(346deg) brightness(97%) contrast(90%)",
                  }}
                />
              </span>
              <span className="relative pb-1">
          ...
          <div
            className="hidden lg:block relative w-full h-[520px] mx-auto"
            ref={canvasRef}
          >
            {/* Card 1: Orange — flies in from LEFT */}
            <div
              className="ms-card absolute left-[13%] top-[25%] w-[190px] h-[190px] z-10"
              style={
                {
                  "--tx": "-120px",
                  "--ty": "0px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "-18px", "--sy": "-18px" } as React.CSSProperties
                }
              >
              ...
              >
                <div className="ms-float-2 w-full h-full text-justify bg-white rounded-[1rem] p-4 shadow-lg border border-slate-100/60 flex flex-col">
                  ...
                  <p className="text-slate-600 text-xs font-medium leading-relaxed font-inter">
                    ...
                    manufacturing reliable hospital furniture, with a strong
            ...
            <div
              className="ms-card absolute left-[25%] top-[55%] w-[190px] h-[190px] z-30"
              style={
                {
                  "--tx": "-80px",
                  "--ty": "100px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "-10px", "--sy": "-10px" } as React.CSSProperties
                }
              >
                <div
                  className="ms-float-3 w-full h-full rounded-[3.5rem] p-6 py-[40px] shadow-lg border border-slate-100/60 text-center flex flex-col justify-center items-center"
                  style={{
                    background:
                      "linear-gradient(135deg, #ffffff 65%, #f7fbfbd7 65%)",
                  }}
                >
                  <span className="text-3xl font-bold text-gray-600 block">
                    1,000
                  </span>
                  <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider block mt-3 leading-snug">
                    Hospital Beds Delivered in a Single Month
                  </span>
                </div>
              </div>
            </div>
            ...
            <div
              className="ms-card absolute left-[35%] top-[23%] w-[190px] h-[210px] z-20"
              style={
                {
                  "--tx": "0px",
                  "--ty": "-120px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "22px", "--sy": "22px" } as React.CSSProperties
                }
              >
                <div
                  className="ms-float-4 w-full h-full rounded-[3.5rem] py-[50px] p-6 shadow-lg border border-slate-100/60 text-center flex flex-col justify-center items-center"
                  style={{
                    background:
                      "linear-gradient(135deg, #ffffff 65%, #f7fbfbd7 65%)",
                  }}
            ...
            <div
              className="ms-card absolute left-[42%] top-[58%] w-6 h-6 z-20"
              style={
                {
                  "--tx": "0px",
                  "--ty": "60px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "-30px", "--sy": "-30px" } as React.CSSProperties
                }
              >
            ...
            <div
              className="ms-card absolute left-[53%] top-[43%] w-[120px] h-[120px] z-10"
              style={
                {
                  "--tx": "0px",
                  "--ty": "100px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "-15px", "--sy": "15px" } as React.CSSProperties
                }
              >
                <div
                  className="ms-float-2 w-full h-full text-white flex flex-col justify-center items-center rounded-[4rem] shadow-xl p-6 text-center"
                  style={{
                    background:
            ...
            <div
              className="ms-card absolute left-[81%] top-[10%] w-6 h-6 z-20"
              style={
                {
                  "--tx": "60px",
                  "--ty": "-60px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "25px", "--sy": "-25px" } as React.CSSProperties
                }
              >
            ...
            <div
              className="ms-card absolute left-[78%] top-[24%] w-[110px] h-[110px] z-20"
              style={
                {
                  "--tx": "100px",
                  "--ty": "0px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "12px", "--sy": "12px" } as React.CSSProperties
                }
              >
            ...
            <div
              className="ms-card absolute left-[70%] top-[58%] w-[190px] h-[190px] z-20"
              style={
                {
                  "--tx": "100px",
                  "--ty": "100px",
            ...
            >
              <div
                className="ms-parallax w-full h-full"
                style={
                  { "--sx": "-20px", "--sy": "-20px" } as React.CSSProperties
                }
              >
                <div
                  className="ms-float-4 w-full h-full rounded-[3rem] p-6 py-[40px] shadow-lg border border-slate-100/60 text-center flex flex-col justify-center items-center"
                  style={{
                    background:
                      "linear-gradient(135deg, #ffffff 65%, #F4F6F8 65%)",
                  }}
                >
                  <span className="text-3xl font-bold text-gray-600 block">
                    30,000+
            ...
            <div
              className="ms-card absolute left-[85%] top-[40%] w-[190px] h-[190px] z-20"
              style={
                {
                  "--tx": "120px",
                  "--ty": "40px",
            ...
            >
              ...
              >
                <div
                  className="ms-float-1 w-full h-full rounded-[3rem] p-6 py-[40px] shadow-lg border border-slate-100/60 text-center flex flex-col justify-center items-center"
                  style={{
                    background:
                      "linear-gradient(135deg, #ffffff 65%, #F4F6F8 65%)",
                  }}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 lg:hidden mt-8">
            {/* Card 1 */}
            <div
              className="ms-card bg-[#E86D24] text-white flex flex-col justify-center items-center rounded-3xl p-6 text-center shadow-lg col-span-1"
              style={
                {
                  "--tx": "-60px",
                  "--ty": "0px",
            ...
            {/* Card 2 Note */}
            <div
              className="ms-card bg-white rounded-3xl p-6 shadow-lg border border-slate-100/60 col-span-2 md:col-span-1 flex flex-col justify-center"
              style={
                {
                  "--tx": "0px",
                  "--ty": "-60px",
            ...
            {/* Card 3 */}
            <div
              className="ms-card rounded-3xl p-6 shadow-lg border border-slate-100/60 text-center col-span-1 flex flex-col justify-center min-h-[140px]"
              style={
                {
                  background:
                    "linear-gradient(135deg, #ffffff 65%, #f7fbfbd7 65%)",
            ...
            {/* Card 6 */}
            <div
              className="ms-card text-white flex flex-col justify-center items-center rounded-3xl p-6 text-center shadow-lg col-span-2 md:col-span-1 min-h-[140px]"
              style={
                {
                  background:
                    "linear-gradient(135deg, #0353A4 65%, rgba(9, 98, 194, 0.95) 65%)",
            ...
            {/* Card 8 */}
            <div
              className="ms-card rounded-3xl p-6 shadow-lg border border-slate-100/60 text-center col-span-2 md:col-span-1 flex flex-col justify-center min-h-[140px]"
              style={
                {
                  background:
                    "linear-gradient(135deg, #ffffff 65%, #f7fbfbd7 65%)",
          ...
          <div className="text-center mt-12">
            <h3 className="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-500 tracking-widest uppercase font-montserrat">
              A Journey Built On Trust, Innovation <br /> &amp; Manufacturing
              Excellence
            </h3>
          </div>
        ...
        >
            ...
            <div className="relative p-8 flex-grow flex flex-col justify-between min-h-[300px]">
              ...
              <div className="space-y-4 pt-4 pb-4">
                ...
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed text-justify font-medium font-inter">
                  We envision a future where healthcare has access to
                  dependable, thoughtfully engineered, and accessible hospital
                  furniture solutions that support better patient care.
                </p>
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed text-justify font-medium font-inter">
                  Our ambition is to grow from a trusted manufacturing partner
                  into a broader healthcare engineering organization,
                  continuously improving products, processes, technology, and
                  service.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative p-8 flex-grow flex flex-col justify-between min-h-[300px]">
              ...
              <div className="space-y-4 pt-4 pb-4">
                ...
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed text-justify font-medium font-inter">
                  Our mission is to manufacture reliable healthcare products by
                  bringing together:
                </p>
                <div className="text-slate-700 text-[10px] sm:text-xs font-semibold text-center border-y border-slate-300/40 py-2.5 my-2 font-inter leading-relaxed bg-white/40 rounded-xl px-2">
                  Advanced Technology + Skilled Manufacturing + Quality
                  Processes + Practical Design + Customer Understanding
                </div>
                <p className="text-slate-600 text-xs sm:text-sm leading-relaxed text-justify font-medium font-inter">
                  We aim to create products that make everyday healthcare
                  environments more functional, efficient, safe, and comfortable
          ...
          >
            ...
            <div className="relative p-8 flex-grow flex flex-col justify-between min-h-[300px]">
              ...
              <div className="space-y-4 pt-4 pb-4">
                <h4 className="text-lg font-bold text-[#0B2545] leading-snug font-montserrat">
                  The principles that guide how we design, manufacture, serve,
                  and grow.
                </h4>
...
`,
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/AboutAs/section5/bgframe.webp')",
        }}
      >
        <div className="flex flex-col lg:flex-row gap-12 items-stretch w-full h-full relative z-10">
          {/* Left Column: Heading */}
          <FadeIn
            className="w-full lg:w-[33%] flex flex-col justify-start space-y-6"
            direction="left"
            delay={0.1}
          >
            ...
            <p className="text-slate-600 text-base leading-relaxed font-medium font-inter text-justify">
              From a small beginning in 1997 to becoming a trusted name in
              healthcare furniture — our journey is built on quality,
              ...
              {[
                ...
                >
                  ...
                  <div className="flex-1 ml-4 space-y-1.5 group-hover:translate-x-1.5 transition-transform duration-300">
                    ...
                    <h3 className="text-base sm:text-2xl font-semibold text-[#0C3D6C] font-montserrat">
                      {item.title}
                    </h3>
      ...
      <section id="capabilities" className="w-full px-[4vw] space-y-12 !mt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-stretch items-center ">
          ...
          >
            ...
            >
              Where Design <br />{" "}
              <span className="text-[#E86D24]">Meets Manufacturing</span>
            </h2>
            ...
            >
              Our manufacturing facility brings multiple production processes
              together under one roof, allowing us to maintain better control
              over quality, precision, and production timelines.
            </p>
            ...
            >
              From raw material processing to fabrication, finishing, assembly,
              and final inspection, every stage is carefully coordinated by our
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 pt-2">
              {[
                ...
                },
                {
                  ...
                  desc: "Systematic wrapping and secure dispatch to ensure products reach healthcare facilities in perfect condition.",
                  icon: "/images/AboutAs/section6/Icons/Simplification (4).svg",
                },
                {
                  title: "Quality Inspection",
                  desc: "Rigorous testing and inspection to ensure every product complies with our strict quality benchmarks.",
...
`,
      ...
      <div className="w-full bg-black flex flex-col !mt-20">
        ...
        <section
          ...
          style={{
            backgroundImage: "url('/images/AboutAs/section7/bgImage.webp')",
          }}
        >
            ...
            >
              ...
              <div className="text-white text-md md:text-lg leading-relaxed space-y-4 font-medium max-w-md">
                <p className="text-slate-300 font-inter text-base sm:text-lg leading-relaxed text-left max-w-2xl">
                  Our values guide every decision we make, from how we design
                  and manufacture our products to how we work with our customers
                  and partners.
                </p>
                <p className="text-slate-300 font-inter text-base sm:text-lg leading-relaxed text-left max-w-2xl">
                  They shape our commitment to quality, reliability, innovation,
                  and continuous improvement, while building lasting
                  relationships through trust, transparency, and accountability.
                </p>
              </div>
            </FadeIn>
        ...
        >
          ...
          <div className="lg:hidden w-full px-[4vw] pt-10 pb-12 flex flex-col gap-8">
            {/* Header */}
            <div
              className="op-header flex justify-between items-center"
              style={{ "--op-i": 0 } as React.CSSProperties}
            >
              <div className="inline-flex items-center gap-3 text-white font-bold text-lg uppercase tracking-wider">
                <span className="relative w-6 h-6 flex-shrink-0">
                  <Image
                    src="/images/AboutAs/sectionIcons/ourPeople.webp"
                    alt="Our People Icon"
                    fill
                    className="object-contain"
                  />
            ...
            {/* Title block */}
            <div
              className="op-header text-center space-y-3"
              style={{ "--op-i": 1 } as React.CSSProperties}
            >
              ...
              <p className="text-slate-400 text-sm leading-relaxed font-inter max-w-sm mx-auto">
                Our team brings together engineers, production specialists,
                skilled fabricators, quality experts, service professionals, and
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {[
                {
                  label: "Engineering",
                  desc: "Turning requirements into practical solutions.",
                  color: "from-[#0c2f52] to-[#0a3d6b]",
                },
                {
                  label: "Production",
                  desc: "Converting designs into dependable products.",
                  color: "from-[#0c2f52] to-[#0a3d6b]",
                },
                {
                  label: "Customer Support",
                  desc: "Keeping communication clear from enquiry to completion.",
                  color: "from-[#0c2f52] to-[#0a3d6b]",
                },
                {
                  label: "Quality",
                  desc: "Maintaining consistency at every stage.",
                  color: "from-[#0c2f52] to-[#0a3d6b]",
                },
                {
                  label: "Service",
                  desc: "Supporting customers beyond delivery.",
                  color: "from-[#0c2f52] to-[#0a3d6b]",
                },
              ].map((dept, idx) => (
                <div
                ...
                >
                  <div className="text-white font-bold text-sm font-montserrat">
                    {dept.label}
                  </div>
                  <div className="text-slate-400 text-[11px] leading-snug font-inter">
                    {dept.desc}
                  </div>
                </div>
              ))}
            ...
            <div className="op-header absolute top-0 left-0 z-10 w-full px-[4vw] pt-16 flex justify-between items-start">
              ...
              <div
                ...
                style={{
                  ...
                  color: "transparent",
                  WebkitMaskImage:
                    "linear-gradient(to right, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0.15) 100%)",
                  maskImage:
                    "linear-gradient(to right, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0.15) 100%)",
                }}
              >
