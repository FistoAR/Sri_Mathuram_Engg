    ...
    new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && entry.boundingClientRect.top > 0) {
          el.classList.remove("sc-v"); void el.offsetHeight; el.classList.add("sc-v");
...
export default function ContactPage() {
  ...
  return (
    <div className="w-full bg-[#FAFBFC] min-h-screen montserrat-page pb-16">
      ...
      {/* ═══ 1. HERO BANNER ═══ */}
      <section className="relative w-full bg-[#0F2D4A] pt-12 pb-24 md:pt-16 md:pb-32 px-[3vw] overflow-hidden" style={{overflowX:'hidden'}}>
        <div className="absolute inset-0 z-0">
          <Image src="/images/ContactPage/HeroBanner.webp" alt="Healthcare Spaces" fill priority sizes="100vw" className="object-cover object-center" />
        </div>

        <div className="relative z-10 w-full mx-auto">
          {/* Label — fades up */}
          <div className="sc-child flex justify-start mb-6 md:mb-12" style={{"--i":0} as React.CSSProperties}>
            <div className="inline-flex items-center gap-2 text-white font-bold text-xl uppercase">
              <span className="relative w-6 h-6 flex-shrink-0">
                <Image src="/images/ContactPage/contactAs.webp" alt="Contact Icon" fill className="object-contain" />
              </span>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white leading-tight mx-auto text-center">
            <span className="hero-line hero-line-1">LET&apos;S BUILD BETTER</span>
            <span className="hero-line hero-line-2">HEALTHCARE SPACES TOGETHER</span>
          </h1>
          ...
          <div className="text-sm md:text-base leading-relaxed mx-auto font-medium max-w-3xl text-center mt-7 space-y-1">
            <span className="hero-desc-line hero-desc-line-1 text-white">
              Whether you are planning a new hospital, upgrading an existing facility,
            </span>
            <span className="hero-desc-line hero-desc-line-2 text-white">
              or looking for reliable medical furniture,{" "}
              <strong className="font-bold text-white">our team is ready to help.</strong>
            </span>
            <span className="hero-desc-line hero-desc-line-3 text-white">
              From enquiry to delivery —{" "}
              <strong className="font-bold text-white">customized solutions</strong> built for healthcare.
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-6 mt-2">
            ...
            >
              <span className="relative w-5 h-5 flex-shrink-0">
                <Image src="/images/ContactPage/quoat 1.webp" alt="Quote Icon" fill className="object-contain" />
              </span>
              Request A Quote
            </button>
            <a href="https://wa.me/919176212345" target="_blank" rel="noopener noreferrer" className="hero-btn-right">
      ...
      {/* ═══ 2. ENQUIRY FORM CARD ═══ */}
      <section id="enquiry-form" className="w-full px-[8vw] -mt-20 md:-mt-28 relative z-20">
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden p-0" ref={obs}>
            ...
            <div className="sc-left lg:col-span-5 bg-[#F8FAFC] p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-slate-200/60 flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                <div className="space-y-2">
                  <h2 className="sc-child text-2xl sm:text-[1.8vw] font-bold text-navy-950 leading-none uppercase" style={{"--i":1} as React.CSSProperties}>GET IN TOUCH</h2>
                  <p className="sc-child text-slate-500 font-medium text-xs sm:text-[0.9vw] leading-relaxed" style={{"--i":2} as React.CSSProperties}>
                    Tell us what you are looking for and our team will get back to you with the right product information and assistance
                  </p>
                  <div className="sc-child w-16 h-1 bg-[#E86D24] mt-3 rounded-full" style={{"--i":3} as React.CSSProperties} />
                </div>
                <div className="space-y-6">
                  {[
                    { icon:"/images/ContactPage/location.webp", label:"Visit Us",
                      content:<p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-medium">Sri Mathurams Medical Engineering<br/>No. 123/13, Industrial Estate,<br/>Guindy, Chennai – 600032,<br/>Tamil Nadu, India.</p> },
                    { icon:"/images/ContactPage/call.webp", label:"Call Us",
                      content:<p className="text-slate-600 text-xs sm:text-sm font-semibold"><a href="tel:+919176212345" className="hover:text-[#E86D24] transition-colors">+91 91762 12345</a></p> },
                    { icon:"/images/ContactPage/mail.webp", label:"Email Us",
                      content:<p className="text-slate-600 text-xs sm:text-sm font-semibold"><a href="mailto:info@srimathurams.com" className="hover:text-[#E86D24] transition-colors">info@srimathurams.com</a></p> },
                    { icon:"/images/ContactPage/businessHours.webp", label:"Business Hours",
                      content:<p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-medium">Monday – Saturday<br/>9:00 AM – 6:00 PM</p> },
                  ].map((item, i) => (
                    <div key={i} className="sc-child flex gap-4" style={{"--i": i + 4} as React.CSSProperties}>
                      <div className="w-10 h-10 rounded-full bg-[#E86D24] flex items-center justify-center flex-shrink-0 relative overflow-hidden p-2.5">
                        <Image src={item.icon} alt={item.label} width={20} height={20} className="object-contain" style={{filter:"brightness(0) invert(1)"}} />
                      </div>
                      <div className="space-y-1">
                        <h4 className="font-bold text-navy-950 text-sm sm:text-base">{item.label}</h4>
                        {item.content}
                      </div>
                    </div>
                  ))}
              ...
              <div className="sc-child space-y-3 pt-6 border-t border-slate-200" style={{"--i":8} as React.CSSProperties}>
                <h4 className="font-bold text-navy-950 text-sm">Follow us on</h4>
                <div className="flex items-center gap-3">
                  {[
                    {href:"https://instagram.com", src:"/images/ContactPage/instagram.webp", alt:"Instagram"},
                    {href:"https://facebook.com",  src:"/images/ContactPage/facebook.webp",  alt:"Facebook"},
                    {href:"https://twitter.com",   src:"/images/ContactPage/twitter.webp",   alt:"Twitter"},
                    {href:"https://linkedin.com",  src:"/images/ContactPage/inkedin.webp",   alt:"LinkedIn"},
                  ].map((s, i) => (
                    <a key={i} href={s.href} target="_blank" rel="noopener noreferrer" className="w-8 h-8 hover:scale-105 transition-all relative block">
      ...
      <section className="w-full px-[3vw] mt-20 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch" ref={obs}>
          {/* Col 1: Visit — from left */}
          <div className="sc-left md:col-span-4 flex flex-col gap-[6vh]">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 text-[#E86D24] font-bold text-lg uppercase">
                <span className="relative w-7 h-7 flex-shrink-0">
                  <Image src="/images/ContactPage/findUs.webp" alt="Find Us" fill className="object-contain" />
                </span>
                <span className="relative pb-1">
                  FIND US
              ...
              <h2 className="text-3xl font-bold text-navy-600 leading-tight">Visit Our Facility</h2>
              <p className="text-slate-600 text-base leading-relaxed font-medium font-inter">Have a project requirement or want to discuss your needs in person?</p>
              <p className="text-slate-600 text-base leading-relaxed font-medium font-inter">Visit our facility and connect directly with our team to explore our products, manufacturing capabilities and customized solutions.</p>
            </div>
            <a href="https://maps.google.com/?q=Industrial+Estate,+Guindy,+Chennai,+Tamil+Nadu" target="_blank" rel="noopener noreferrer" className="inline-block">
          ...
          <div className="sc-up md:col-span-4 min-h-[250px] md:min-h-0 rounded-3xl overflow-hidden shadow-md border border-slate-100 relative bg-slate-100">
            <iframe
          ...
          <div className="sc-right md:col-span-4 flex flex-col justify-between space-y-6 md:pl-4">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 text-[#E86D24] font-bold text-lg uppercase">
                <span className="relative w-7 h-7 flex-shrink-0">
                  <Image src="/images/ContactPage/contact.webp" alt="Quick Contact" fill className="object-contain" />
                </span>
                <span className="relative pb-1">
                  QUICK CONTACT
                  <span className="absolute left-0 bottom-0 w-1/2 h-[2px] bg-[#E86D24] rounded-full" />
              ...
              <h2 className="text-3xl font-bold text-navy-600 leading-tight">Need Assistance?</h2>
              <p className="text-slate-600 text-base leading-relaxed font-medium font-inter">For urgent product enquiries or quotation requirements, contact our team directly.</p>
            </div>
            <div className="space-y-4 pt-4 border-t border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#E86D24] flex items-center justify-center flex-shrink-0 relative overflow-hidden p-2">
                  <Image src="/images/ContactPage/call.webp" alt="Call" width={16} height={16} className="object-contain" style={{filter:"brightness(0) invert(1)"}} />
                </div>
                <a href="tel:+919176212345" className="text-gray-700 hover:text-[#E86D24] font-semibold text-md transition-colors">+91 91762 12345</a>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#E86D24] flex items-center justify-center flex-shrink-0 relative overflow-hidden p-2">
                  <Image src="/images/ContactPage/mail.webp" alt="Mail" width={16} height={16} className="object-contain" style={{filter:"brightness(0) invert(1)"}} />
                </div>
                <a href="mailto:info@srimathurams.com" className="text-gray-700 hover:text-[#E86D24] font-semibold text-md transition-colors">info@srimathurams.com</a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="https://wa.me/919176212345" target="_blank" rel="noopener noreferrer" className="text-[#25D366] hover:underline font-semibold text-md flex items-center gap-1">
      ...
      <section className="w-full px-[3vw] mt-20">
        <div
          ...
          ref={(el) => {
            ...
            new IntersectionObserver(([entry]) => {
              if (entry.isIntersecting && entry.boundingClientRect.top > 0) {
                el.classList.remove("ctac-v"); void el.offsetHeight; el.classList.add("ctac-v");
              } else if (entry.boundingClientRect.top > window.innerHeight) {
        ...
        >
          <div className="absolute inset-0 z-0">
            <Image src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=2000&q=90" alt="Operation Theatre" fill sizes="100vw" className="object-cover object-right filter brightness-50 contrast-125" />
          ...
          <div className="relative z-10 w-full px-8 md:px-12 py-10 flex flex-col justify-center">
            <div className="ctac relative inline-flex items-center gap-3 pb-2.5 max-w-full" style={{"--ci":0} as React.CSSProperties}>
              <svg className="w-8 h-8 sm:w-[34px] sm:h-[34px] lg:w-5 lg:h-5 text-[#E86D24] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h2 className="ctac text-2xl md:text-4xl font-semibold text-white leading-tight mt-4" style={{"--ci":1} as React.CSSProperties}>
              Looking for Complete Hospital <br className="hidden sm:inline" /> Furniture Solutions?
            </h2>
            <p className="ctac text-slate-200 text-md sm:text-md mt-3 font-medium" style={{"--ci":2} as React.CSSProperties}>
            ...
            <div className="ctac flex flex-wrap gap-4 pt-6" style={{"--ci":3} as React.CSSProperties}>
              <button
                onClick={() => openInquiryModal({
