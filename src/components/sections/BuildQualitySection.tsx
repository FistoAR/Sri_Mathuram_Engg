...
const stepsData: StepItem[] = [
  {
    ...
    image: "/images/Home Page/HowWeBuild/product-design.webp",
  },
  {
    id: "step-2",
    stepNumber: "STEP-02",
    ...
    image: "/images/Home Page/HowWeBuild/precision-fabrication.webp",
  },
  {
    id: "step-3",
    stepNumber: "STEP-03",
    ...
    image: "/images/Home Page/HowWeBuild/power-coating.webp",
  },
  {
    id: "step-4",
    stepNumber: "STEP-04",
    ...
    image: "/images/Home Page/HowWeBuild/assembly.webp",
  },
  {
    id: "step-5",
    stepNumber: "STEP-05",
    ...
    image: "/images/Home Page/HowWeBuild/quality-inspection.webp",
  },
  {
    id: "step-6",
    stepNumber: "STEP-06",
    ...
    image: "/images/Home Page/HowWeBuild/packaging-and-delivery.webp",
  },
];
        ...
        <div className="w-full mx-auto relative z-10 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 pt-2 items-center">
            ...
            <div ref={cardsRef} className="lg:col-span-8 relative flex flex-col justify-center w-full">
              ...
              {/* Interactive Accordion Cards Flex Row (Desktop) with Staggered Scroll Animation */}
              <motion.div
                ...
                {stepsData.map((step, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      style={{ transition: 'flex-grow 1000ms cubic-bezier(0.16, 1, 0.3, 1), min-width 1000ms cubic-bezier(0.16, 1, 0.3, 1), opacity 300ms ease' }}
                    >
                      {/* Background Image */}
                      <Image
                        src={step.image}
